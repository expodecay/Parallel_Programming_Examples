 ...
 *                                                                              *
********************************************************************************/
// C:\opencv45\build\install\setup_vars_opencv4.cmd .\mpi_windows_x64.exe --try_cuda yes --expos_comp no --warp plane --wave_correct no  --features surf --match_conf 0.3 ..\..\images\4k\img_0.jpg ..\..\images\4k\img_1.jpg
...
// mpiexec - n 2 .\mpi_windows_x64.exe

//int main(int argc, char** argv) {
//
//    const int PING_PONG_LIMIT = 4;
//
...
//        }
//        else {
//            MPI_Recv(&ping_pong_count, 1, MPI_INT, partner_rank, MPI_ANY_TAG, MPI_COMM_WORLD,
//                MPI_STATUS_IGNORE);
...
// mpiexec -n 1 C:\opencv45\build\install\setup_vars_opencv4.cmd .\mpi_windows_x64.exe --try_cuda no --expos_comp no --warp plane --wave_correct no  --features surf --match_conf 0.3 ..\..\images\4k\img_0.jpg ..\..\images\4k\img_1.jpg
